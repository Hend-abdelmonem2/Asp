...
namespace challenge_Diabetes.Migrations
{
    ...
    [Migration("20240701201118_updatedoctorcomment")]
    partial class updatedoctorcomment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("challange_Diabetes.Model.DoctorComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("challange_Diabetes.Model.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("challange_Diabetes.Model.PostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("challange_Diabetes.Model.Favorite", b =>
                {
                    b.HasOne("challenge_Diabetes.Model.Doctor", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("challange_Diabetes.Model.Like", b =>
                {
                    b.HasOne("challange_Diabetes.Model.Post", "Post")
                        .WithMany("Likes")
